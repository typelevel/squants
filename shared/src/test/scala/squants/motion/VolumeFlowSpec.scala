...
class VolumeFlowSpec extends AnyFlatSpec with Matchers with CustomMatchers {
  ...
  it should "create values using UOM factories" in {
    ...
    CubicFeetPerDay(1).toCubicFeetPerDay should be(1)
    CubicFeetPerHour(1).toCubicFeetPerHour should be(1)
    CubicFeetPerMinute(1).toCubicFeetPerMinute should be(1)
    CubicFeetPerSecond(1).toCubicFeetPerSecond should be(1)
  ...
  it should "create values from properly formatted Strings" in {
    ...
    VolumeFlow("10.22 ft³/d").get should be(CubicFeetPerDay(10.22))
    VolumeFlow("10.22 ft³/hr").get should be(CubicFeetPerHour(10.22))
    VolumeFlow("10.22 ft³/m").get should be(CubicFeetPerMinute(10.22))
    VolumeFlow("10.22 cfs").get should be(CubicFeetPerSecond(10.22))
  ...
  it should "properly convert to all supported Units of Measure" in {
    ...
    x.toCubicFeetPerDay should be(CubicMeters(10.22).toCubicFeet / Seconds(1).toDays +- 0.00000001)
    x.toCubicFeetPerHour should be(CubicMeters(10.22).toCubicFeet / Seconds(1).toHours +- 0.00000001)
    x.toCubicFeetPerMinute should be(CubicMeters(10.22).toCubicFeet / Seconds(1).toMinutes +- 0.00000001)
    x.toCubicFeetPerSecond should be(CubicMeters(10.22).toCubicFeet / Seconds(1).toSeconds +- 0.00000001)
  ...
  it should "provide aliases for single unit values" in {
    ...
    cubicFeetPerDay should be(CubicFeetPerDay(1))
    cubicFeetPerHour should be(CubicFeetPerHour(1))
    cubicFeetPerMinute should be(CubicFeetPerMinute(1))
    cubicFeetPerSecond should be(CubicFeetPerSecond(1))
  ...
  it should "provide implicit conversion from Double" in {
    ...
    d.cubicFeetPerDay should be(CubicFeetPerDay(d))
    d.cubicFeetPerHour should be(CubicFeetPerHour(d))
    d.cubicFeetPerMinute should be(CubicFeetPerMinute(d))
    d.cubicFeetPerSecond should be(CubicFeetPerSecond(d))
