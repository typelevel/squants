...
object Density extends Dimension("Density") {
  ...
  override lazy val units: Set[UnitOfMeasure[this.type]] = 
    Set(NanogramsPerLitre, MicrogramsPerLitre, NanogramsPerMillilitre, MicrogramsPerMillilitre, NanogramsPerMicrolitre, MilligramsPerLitre, MicrogramsPerMicrolitre, NanogramsPerNanolitre, KilogramsPerCubicMeter, MilligramsPerMillilitre, GramsPerLitre, MicrogramsPerNanolitre, MilligramsPerMicrolitre, KilogramsPerLitre, GramsPerMillilitre, MilligramsPerNanolitre, KilogramsPerMillilitre, GramsPerMicrolitre, KilogramsPerMicrolitre, GramsPerNanolitre, KilogramsPerNanolitre)
