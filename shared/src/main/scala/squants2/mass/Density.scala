...
object Density extends Dimension("Density") {
  ...
  override lazy val units: Set[UnitOfMeasure[this.type]] = 
    Set(NanogramsPerLitre, MicrogramsPerLitre, NanogramsPerMillilitre, MicrogramsPerMillilitre, NanogramsPerMicrolitre, MilligramsPerLitre, MicrogramsPerMicrolitre, NanogramsPerNanolitre, GramsPerLitre, MilligramsPerMillilitre, KilogramsPerCubicMeter, MicrogramsPerNanolitre, MilligramsPerMicrolitre, KilogramsPerLitre, GramsPerMillilitre, MilligramsPerNanolitre, GramsPerMicrolitre, KilogramsPerMillilitre, GramsPerNanolitre, KilogramsPerMicrolitre, KilogramsPerNanolitre)
