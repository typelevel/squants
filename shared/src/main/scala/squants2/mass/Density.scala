...
case object KilogramsPerLitre extends DensityUnit("kg/L", 1000)
...
case object GramsPerMicrolitre extends DensityUnit("g/µl", 1000000)
case object KilogramsPerMillilitre extends DensityUnit("kg/ml", 1000000)
