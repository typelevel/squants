...
object VolumeFlow extends Dimension[VolumeFlow]("Volume Flow") {
  ...
  lazy val nanolitrePerDay: VolumeFlow[Int] = NanolitresPerDay(1)
  lazy val nanolitrePerHour: VolumeFlow[Int] = NanolitresPerHour(1)
  lazy val microlitrePerDay: VolumeFlow[Int] = MicrolitresPerDay(1)
  lazy val nanolitrePerMinute: VolumeFlow[Int] = NanolitresPerMinute(1)
  lazy val microlitrePerHour: VolumeFlow[Int] = MicrolitresPerHour(1)
  lazy val nanolitrePerSecond: VolumeFlow[Int] = NanolitresPerSecond(1)
  lazy val millilitrePerDay: VolumeFlow[Int] = MillilitresPerDay(1)
  lazy val microlitrePerMinute: VolumeFlow[Int] = MicrolitresPerMinute(1)
  lazy val millilitrePerHour: VolumeFlow[Int] = MillilitresPerHour(1)
  lazy val microlitrePerSecond: VolumeFlow[Int] = MicrolitresPerSecond(1)
  lazy val litrePerDay: VolumeFlow[Int] = LitresPerDay(1)
  lazy val millilitrePerMinute: VolumeFlow[Int] = MillilitresPerMinute(1)
  lazy val gallonPerDay: VolumeFlow[Int] = GallonsPerDay(1)
  lazy val litrePerHour: VolumeFlow[Int] = LitresPerHour(1)
  lazy val millilitrePerSecond: VolumeFlow[Int] = MillilitresPerSecond(1)
  lazy val gallonPerHour: VolumeFlow[Int] = GallonsPerHour(1)
  lazy val cubicFeetPerHour: VolumeFlow[Int] = CubicFeetPerHour(1)
  lazy val litrePerMinute: VolumeFlow[Int] = LitresPerMinute(1)
  lazy val gallonPerMinute: VolumeFlow[Int] = GallonsPerMinute(1)
  lazy val litrePerSecond: VolumeFlow[Int] = LitresPerSecond(1)
  lazy val gallonPerSecond: VolumeFlow[Int] = GallonsPerSecond(1)
  lazy val cubicMeterPerSecond: VolumeFlow[Int] = CubicMetersPerSecond(1)
