...
// */
//abstract class SVector[A, Q[_] <: Quantity[A, Q]] {
//
...
//   * @return
//   */
//  def dotProduct[B](that: SVector[B, Dimensionless[_]])(implicit f: B => A): A
//  def *[B](that: SVector[B, Dimensionless[_]])(implicit f: B => A): A = dotProduct(that)
//
//  /**
...
//   * @return
//   */
//  def crossProduct[B](that: SVector[B, Dimensionless[_]])(implicit f: B => A): SVector[A, Q]
//  def #*[B](that: SVector[B, Dimensionless[_]])(implicit f: B => A): SVector[A, Q] = crossProduct(that)
//
//}
//
//object SVector {
...
// */
//case class SVectorImpl[A, Q[_] <: Quantity[A, Q]](coordinates: Seq[Quantity[A, Q]])(implicit num: Numeric[A]) extends SVector[A, Q] {
...
//   * @return
//   */
//  def map[B: Numeric, E[_] <: Quantity[B, E]](f: Quantity[A, Q] => Quantity[B, E]): SVector[B, E] = SVectorImpl(coordinates.map(q => f(q)))
//
//  /**
//   * Add two Vectors
//   *
...
//    SVectorImpl(coordinates.zipAll(that.coordinates, valueUnit(num.zero), valueUnit(num.zero)).map(v ⇒ (v._1 + v._2).asInstanceOf[Quantity[A,Q]])).asInstanceOf[SVectorType]
//
//  /**
//   * Subtract two Vectors
//   *
...
//   * @return
//   */
//  override def dotProduct[B](that: SVector[B, Dimensionless[_]])(implicit f: B => A): A =
...
//   * @return
//   */
//  override def crossProduct[B](that: SVector[B, Dimensionless[_]])(implicit f: B => A): SVector[A, Q] = {
...
//   * @return
//   */
//  def to(uom: UnitOfMeasure[Q]): SVector[A, Dimensionless[_]] = map(q => Each(q.to(uom)))
//
//  /**
