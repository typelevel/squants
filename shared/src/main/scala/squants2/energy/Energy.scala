...
final case class Energy[A: Numeric] private[squants2] (value: A, unit: EnergyUnit)
  extends Quantity[A, Energy] with TimeIntegral[A, Power] {

  override protected[squants2] def timeDerived: Power[A] = Watts(num.one)
...
object Energy extends Dimension[Energy]("Energy") {
  ...
  lazy val picojoule: Energy[Int] = Picojoules(1)
  lazy val gigaElectronVolt: Energy[Int] = GigaElectronVolt(1)
  lazy val nanojoule: Energy[Int] = Nanojoules(1)
  lazy val erg: Energy[Int] = Ergs(1)
  lazy val teraElectronVolt: Energy[Int] = TeraElectronVolt(1)
  lazy val microjoule: Energy[Int] = Microjoules(1)
  lazy val petaElectronVolt: Energy[Int] = PetaElectronVolt(1)
  lazy val millijoule: Energy[Int] = Millijoules(1)
  lazy val exaElectronVolt: Energy[Int] = ExaElectronVolt(1)
  lazy val joule: Energy[Int] = Joules(1)
  lazy val milliwattHour: Energy[Int] = MilliwattHours(1)
  lazy val kilojoule: Energy[Int] = Kilojoules(1)
  lazy val britishThermalUnit: Energy[Int] = BritishThermalUnits(1)
  lazy val wattHour: Energy[Int] = WattHours(1)
  lazy val megajoule: Energy[Int] = Megajoules(1)
  lazy val mBtu: Energy[Int] = MBtus(1)
  lazy val kilowattHour: Energy[Int] = KilowattHours(1)
  lazy val gigajoule: Energy[Int] = Gigajoules(1)
  lazy val mMBtu: Energy[Int] = MMBtus(1)
  lazy val megawattHour: Energy[Int] = MegawattHours(1)
  lazy val terajoule: Energy[Int] = Terajoules(1)
  lazy val gigawattHour: Energy[Int] = GigawattHours(1)
