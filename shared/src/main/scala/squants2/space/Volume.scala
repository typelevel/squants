...
final case class Volume[A: Numeric] private[squants2] (value: A, unit: VolumeUnit)
  extends Quantity[A, Volume] with TimeIntegral[A, VolumeFlow] {

  override protected[squants2] def timeDerived: VolumeFlow[A] = CubicMetersPerSecond(num.one)
...
object Volume extends Dimension[Volume]("Volume") {
  ...
  lazy val nanolitre: Volume[Int] = Nanolitres(1)
  lazy val microlitre: Volume[Int] = Microlitres(1)
  lazy val millilitre: Volume[Int] = Millilitres(1)
  lazy val teaspoon: Volume[Int] = Teaspoons(1)
  lazy val centilitre: Volume[Int] = Centilitres(1)
  lazy val tablespoon: Volume[Int] = Tablespoons(1)
  lazy val cubicInche: Volume[Int] = CubicInches(1)
  lazy val fluidOunce: Volume[Int] = FluidOunces(1)
  lazy val decilitre: Volume[Int] = Decilitres(1)
  lazy val usCup: Volume[Int] = UsCups(1)
  lazy val usPint: Volume[Int] = UsPints(1)
  lazy val usQuart: Volume[Int] = UsQuarts(1)
  lazy val litre: Volume[Int] = Litres(1)
  lazy val usGallon: Volume[Int] = UsGallons(1)
  lazy val cubicFeet: Volume[Int] = CubicFeet(1)
  lazy val hectolitre: Volume[Int] = Hectolitres(1)
  lazy val cubicYard: Volume[Int] = CubicYards(1)
  lazy val cubicMeter: Volume[Int] = CubicMeters(1)
  lazy val acreFeet: Volume[Int] = AcreFeet(1)
  lazy val cubicUsMile: Volume[Int] = CubicUsMiles(1)
