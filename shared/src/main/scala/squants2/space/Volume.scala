...
object Volume extends Dimension[Volume]("Volume") {
  ...
  lazy val uCups: Volume[Int] = UsCups(1)
  lazy val uPints: Volume[Int] = UsPints(1)
  lazy val uQuarts: Volume[Int] = UsQuarts(1)
  lazy val litre: Volume[Int] = Litres(1)
  lazy val uGallons: Volume[Int] = UsGallons(1)
  ...
  lazy val cubicUMiles: Volume[Int] = CubicUsMiles(1)
