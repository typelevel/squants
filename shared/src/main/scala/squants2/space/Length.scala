...
object Length extends BaseDimension[Length]("Length", "L") {
  ...
  lazy val internationalMile: Length[Int] = InternationalMiles(1)
  lazy val usMile: Length[Int] = UsMiles(1)
  lazy val nauticalMile: Length[Int] = NauticalMiles(1)
  ...
  lazy val astronomicalUnit: Length[Int] = AstronomicalUnits(1)
  lazy val exaElectronVoltLength: Length[Int] = ExaElectronVoltLength(1)
  lazy val lightYear: Length[Int] = LightYears(1)
  lazy val parsec: Length[Int] = Parsecs(1)
  lazy val kiloParsec: Length[Int] = KiloParsecs(1)
  lazy val megaParsec: Length[Int] = MegaParsecs(1)
  lazy val gigaParsec: Length[Int] = GigaParsecs(1)
