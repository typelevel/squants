...
case object KilobytesPerSecond extends DataRateUnit("KB/s", 1000)
case object KibibytesPerSecond extends DataRateUnit("KiB/s", 1024)
...
case object MegabytesPerSecond extends DataRateUnit("MB/s", 1000000)
case object MebibytesPerSecond extends DataRateUnit("MiB/s", 1048576)
...
case object GigabytesPerSecond extends DataRateUnit("GB/s", 1000000000)
case object GibibytesPerSecond extends DataRateUnit("GiB/s", 1073741824)
