...
case object Kibibytes extends InformationUnit("KiB", 1024.0)
case object Megabits extends InformationUnit("Mbit", 125000.0)
case object Mebibits extends InformationUnit("Mibit", 131072.0)
case object Megabytes extends InformationUnit("MB", 1000000.0)
case object Mebibytes extends InformationUnit("MiB", 1048576.0)
case object Gigabits extends InformationUnit("Gbit", 1.25E8)
case object Gibibits extends InformationUnit("Gibit", 1.34217728E8)
case object Gigabytes extends InformationUnit("GB", 1.0E9)
case object Gibibytes extends InformationUnit("GiB", 1.073741824E9)
...
case object Terabytes extends InformationUnit("TB", 1.0E12)
case object Tebibytes extends InformationUnit("TiB", 1.099511627776E12)
...
case object Petabytes extends InformationUnit("PB", 1.0E15)
case object Pebibytes extends InformationUnit("PiB", 1.125899906842624E15)
...
case object Exabytes extends InformationUnit("EB", 1.0E18)
case object Exbibytes extends InformationUnit("EiB", 1.15292150460684698E18)
...
case object Zettabytes extends InformationUnit("ZB", 1.0E21)
case object Zebibytes extends InformationUnit("ZiB", 1.1805916207174113E21)
...
case object Yottabytes extends InformationUnit("YB", 1.0E24)
case object Yobibytes extends InformationUnit("YiB", 1.2089258196146292E24)
