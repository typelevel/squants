...
case object Kilobytes extends InformationUnit("KB", 1000)
case object Kibibytes extends InformationUnit("KiB", 1024)
case object Megabits extends InformationUnit("Mbit", 125000)
case object Mebibits extends InformationUnit("Mibit", 131072)
case object Megabytes extends InformationUnit("MB", 1000000)
case object Mebibytes extends InformationUnit("MiB", 1048576)
case object Gigabits extends InformationUnit("Gbit", 125000000)
case object Gibibits extends InformationUnit("Gibit", 134217728)
case object Gigabytes extends InformationUnit("GB", 1000000000)
case object Gibibytes extends InformationUnit("GiB", 1073741824)
