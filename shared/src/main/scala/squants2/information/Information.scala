...
object Information extends BaseDimension[Information]("Information", "B") {
  ...
  lazy val bit: Information[Int] = Bits(1)
  lazy val byte: Information[Int] = Bytes(1)
  lazy val kilobit: Information[Int] = Kilobits(1)
  lazy val kibibit: Information[Int] = Kibibits(1)
  lazy val kilobyte: Information[Int] = Kilobytes(1)
  lazy val kibibyte: Information[Int] = Kibibytes(1)
  lazy val megabit: Information[Int] = Megabits(1)
  lazy val mebibit: Information[Int] = Mebibits(1)
  lazy val megabyte: Information[Int] = Megabytes(1)
  lazy val mebibyte: Information[Int] = Mebibytes(1)
  lazy val gigabit: Information[Int] = Gigabits(1)
  lazy val gibibit: Information[Int] = Gibibits(1)
  lazy val gigabyte: Information[Int] = Gigabytes(1)
  lazy val gibibyte: Information[Int] = Gibibytes(1)
  lazy val terabit: Information[Int] = Terabits(1)
  lazy val tebibit: Information[Int] = Tebibits(1)
  lazy val terabyte: Information[Int] = Terabytes(1)
  lazy val tebibyte: Information[Int] = Tebibytes(1)
  lazy val petabit: Information[Int] = Petabits(1)
  lazy val pebibit: Information[Int] = Pebibits(1)
  lazy val petabyte: Information[Int] = Petabytes(1)
  lazy val pebibyte: Information[Int] = Pebibytes(1)
  lazy val exabit: Information[Int] = Exabits(1)
  lazy val exbibit: Information[Int] = Exbibits(1)
  lazy val exabyte: Information[Int] = Exabytes(1)
  lazy val exbibyte: Information[Int] = Exbibytes(1)
  lazy val zettabit: Information[Int] = Zettabits(1)
  lazy val zebibit: Information[Int] = Zebibits(1)
  lazy val zettabyte: Information[Int] = Zettabytes(1)
  lazy val zebibyte: Information[Int] = Zebibytes(1)
  lazy val yottabit: Information[Int] = Yottabits(1)
  lazy val yobibit: Information[Int] = Yobibits(1)
  lazy val yottabyte: Information[Int] = Yottabytes(1)
  lazy val yobibyte: Information[Int] = Yobibytes(1)
